const Commands = [
	...
	},
	{
		name: "code executer",
		description:
			"Permets d'exécuter un bloc de code et retourne la sortie dans un message",
		options: [
			{
				name: "langage",
	...
	{
		name: "rappel liste",
		description: "Lister ses rappels programmés",
	},
	{
		name: "report",
	...
	},
	{
		...
		options: [
			...
			{
				name: "notification",
				type: "BOOLEEN - Être notifié à la fin du temps",
			},
			{
				name: "repetition",
				type: "NOMBRE - Nombre de répétitions de la session",
			}
		],
	},
	{
