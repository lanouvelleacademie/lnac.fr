...
const OpenPositions = [
	...
	
	{
		...
		profile: [
			...
			"Vous savez utiliser les outils d'automatisation des différents réseaux sociaux",
	...
	},
	{
		...
		profile: [
			...
			"Vous êtes créatif·ve et avez un sens artistique développé.",
			"Vous avez la capacité à comprendre et à interpréter les besoins en communication visuelle.",
            "Vous savez travailler en équipe",
		],
		skills: [
	...
	},
    {
        ...
        description: [
            ...
            "Vous serez également chargé de concevoir des animations engageantes et régulières pour notre communauté.",
        ],
        profile: [
